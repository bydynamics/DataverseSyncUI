pageextension 80004 "Job Synch Extension" extends "Job Card"
{
    actions
    {
        addlast(navigation)
        {
            group(ActionGroupCDS)
            {
                ...
                action(CDSGotoJob)
                {
                    ...
                    ApplicationArea = All;
                    ToolTip = 'Open the coupled Dataverse job.';
                ...
                group(Coupling)
                {
                    ...
                    action(ManageCDSCoupling)
                    {
                        ...
                        Visible = true;
                        Image = LinkAccount;
                        ToolTip = 'Create or modify the coupling to a Microsoft Dataverse Job.';
                    ...
                    action(DeleteCDSCoupling)
                    {
                        ...
                        Image = UnLinkAccount;
                        Enabled = CDSIsCoupledToRecord;
                        ToolTip = 'Delete the coupling to a Microsoft Dataverse Job.';
